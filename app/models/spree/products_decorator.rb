module Spree
  Product.class_eval do
    ...
    attr_accessible :google_merchant_include_variants, :google_merchant_brand, :google_merchant_product_category, :google_merchant_product_type, :google_merchant_gtin
